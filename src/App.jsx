  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Texte */}
        <p
          className="font-body text-center text-sm mb-4 leading-relaxed"
        ...
        {/* Bonus */}
        <p
          className="font-body text-xs text-center mt-2 font-semibold"
          style={{ color: '#E8B96A' }}
        >
...
export default function App() {
  ...
  return (
    <BrowserRouter>
      {showWelcome && (
        <WelcomePopup onDone={() => setShowWelcome(false)} />
      )}
      <AnimatedRoutes />
    </BrowserRouter>
  );
