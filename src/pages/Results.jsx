...
[span_2](start_span)// Initialisation de Supabase[span_2](end_span)
...
export default function Results() {
  ...
  // Sécurité pour l'affichage des images locales
  ...
  const handleTryStyle = async (style) => {
    ...
    try {
      [span_3](start_span)// 1. Upload vers Supabase[span_3](end_span)
      ...
      [span_4](start_span)// 2. Appel API Replicate[span_4](end_span)
      ...
      if (!res.ok) throw new Error(data.error || "L'IA n'a pas pu générer l'image.");

      [span_5](start_span)// 3. Succès[span_5](end_span)
      consumeTransform();
