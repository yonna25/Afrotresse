...
export default function Results() {
  ...
  return (
    <div className="px-4 py-6 space-y-5 bg-[#2b1810] min-h-screen pb-28">
      ...
      {/* Navigation historique session */}
      {totalHistory > 1 && (
        <div className="flex items-center justify-between bg-[#3a2118] rounded-xl px-4 py-2"
          style={{ border: "1px solid rgba(201,150,58,0.2)" }}>
          <button
            onClick={goToPrevHistory}
            disabled={isOnFirst}
            className="flex items-center gap-1.5 text-xs font-semibold disabled:opacity-30"
            style={{ color: "#FFC000" }}>
          ...
          <span className="text-xs text-gray-400">
            Analyse {currentHistoryPos} / {totalHistory}
          </span>
          <button
      ...
      {/* Navigation pagination + historique */}
